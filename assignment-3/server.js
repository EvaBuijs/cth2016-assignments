...
var pattern_1 = ['How do you do?', "What's up", 'Hi there!'];
var pattern_2 = ['No', "Are you crazy", 'Hmmm'];
var pattern_3 = ['Ok', 'Good '];

// helpful punctuation
var punctuation = ['!', '.', '...'];

/**
* Iterates through and array of clauses or words and search them inside a given sentence (msg). Returns
  ...
  switch(choice([1, 2, 3]))
  {
    ...
    case 2:
      return choice(['I am sorry', 'Excuse me', 'Eh...']) + ' I do ' + choice(['not', 'indeed']) + ' '
        ...
        + choice(punctuation);
    case 3:
      return choice(['YES', 'Ok', 'Zzzzz']) + choice(punctuation) + choice(punctuation) + choice(punctuation);
  }
}

function patter_3_answer() {
return choice(['Lalala', 'Lululu', 'Lololo']);
}
